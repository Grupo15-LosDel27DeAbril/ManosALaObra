...
public class InitServiceInMemory {
   ...
   private void fireInitialData(){
       ...
       App app = new AppBuilder().withProductos(new ArrayList<Producto>())
               ...
               .withProductos(new ArrayList<Producto>())
               .build();
       Usuario usuario1 = new UsuarioBuilder().withNombreUsuario("alex.quinhonez@gmail.com")
               ...
               .withPassword("8787")
               .build();
       Producto producto = new Producto("Naranjas", "6 naranjas dulces", "https://thumbs.dreamstime.com/z/naranjas-en-plato-36927385.jpg", "Frutas", -34.720788, -58.254520, "Catedral de Quilmes", LocalDate.of(2020, 10, 13), LocalDate.of(2020, 10, 23), usuario1.getNombreUsuario(), new ArrayList<Mail>(), "Disponible", usuario1.getId(), false);
       productoService.save(producto);
       usuario1.donarProducto(producto, app);
       producto = new Producto("Arroz", "3 paquetes de arroz de 1 kg c/u", "https://s1.eestatic.com/2019/01/11/ciencia/nutricion/Nutricion_367724011_112039587_1706x1280.jpg", "Alimento no perecedero", -34.746174, -58.241824, "Frigorifico", LocalDate.of(2020, 10, 05), LocalDate.of(2020, 10, 15), usuario1.getNombreUsuario(), new ArrayList<Mail>(), "Disponible", usuario1.getId(), false);
       productoService.save(producto);
       usuario1.donarProducto(producto, app);
