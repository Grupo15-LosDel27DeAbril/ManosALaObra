...
public class DonacionesControllerTest {
    ...
    public void testObtenerDonacionPorId() throws Exception{
        ...
        Producto producto1 = new Producto("Naranjas", "6 naranjas dulces", "https://thumbs.dreamstime.com/z/naranjas-en-plato-36927385.jpg", "Frutas", -34.720659, -58.254300, "Catedral de Quilmes", LocalDate.of(2020, 10, 13), LocalDate.of(2020, 10, 23 ), "alex.quinhonez@gmail.com");
    ...
    public void testRealizarDonacion() throws Exception{
        ...
        Producto producto = new Producto("Polenta", "Un paquete de polenta en buen estado", "una imagen", "Alimento", -36.657634, -58.532456, "La Plata", LocalDate.of(2020, 10, 10), LocalDate.of(2020, 10, 20), usuario.getEmail());
        //producto.setId(1L);
    ...
    public void testObtenerBusquedaCorrecta() throws Exception{
        ...
        Producto producto1 = new Producto("Arroz", "3 paquetes de arroz de 1 kg c/u", "https://s1.eestatic.com/2019/01/11/ciencia/nutricion/Nutricion_367724011_112039587_1706x1280.jpg", "Alimento no parecedero", -34.746174, -58.241824, "Frigorifico", LocalDate.of(2020, 10, 12), LocalDate.of(2020, 10, 22), "alex.quinhonez@gmail.com");
    ...
    public void testObtenerBusquedaIncorrecta() throws Exception{
        ...
        Producto producto1 = new Producto("Naranjas", "6 naranjas dulces", "https://thumbs.dreamstime.com/z/naranjas-en-plato-36927385.jpg", "Frutas", -34.720659, -58.254300, "Catedral de Quilmes", LocalDate.of(2020, 10, 11), LocalDate.of(2020, 10, 25), "alex.quinhonez@gmail.com");
